...
public class FrameGausJordan extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnVerificarMatriz = new javax.swing.JButton();
        ...
        btnVerificarMatriz.setText("Verificar Matriz");
        btnVerificarMatriz.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVerificarMatrizActionPerformed(evt);
            }
        });
                ...
                .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlInfoLayout.createSequentialGroup()
                        .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lblingrese, javax.swing.GroupLayout.DEFAULT_SIZE, 183, Short.MAX_VALUE)
                            .addComponent(btnVerificarMatriz, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        ...
                        .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlInfoLayout.createSequentialGroup()
                                .addComponent(txtnovariables, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnlInfoLayout.setVerticalGroup(
            ...
            .addGroup(pnlInfoLayout.createSequentialGroup()
                ...
                .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblingrese, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnVerificarMatriz))
    ...
    private void btnVerificarMatrizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarMatrizActionPerformed
 
        int index = 0;
      
while(index < listamatrizA.size()){
    
    if (listamatrizA.get(index).getText().equals("0")) {

            btnSolucion.setEnabled(false);

            JOptionPane.showMessageDialog(null, "Hay un cero en la diagonal Principal", "Error", JOptionPane.ERROR_MESSAGE);
...
btnSolucion.setEnabled(true);
    ...
    }//GEN-LAST:event_btnVerificarMatrizActionPerformed
...
////////////////////Metodos para poder crear los textFields necesarios segun el usuario los necesite/////////
    ...
    static void ValidarCeros(List<JTextField> lista, int tamano) {

        int index = 0;
        for (JTextField lista1 : lista) {
            if (lista.get(index).getText().equals("0")) {

                JOptionPane.showMessageDialog(null, "Hay una serpiente en mi bota", "error", JOptionPane.ERROR_MESSAGE);
                break;
    ...
    private javax.swing.JButton btnVerificarMatriz;
